...
import (
	...
	"github.com/practic-go/gin/blog/internal/service"
...
// curl -X POST http://127.0.0.1:8999/api/v1/tags -F 'name=Golang' -F created_by=biny
...
// curl -X PUT http://127.0.0.1:8999/api/v1/tags/2 -F state=1 -F name=PHP2 -F modified_by=biny
...
// curl -X DELETE  http://127.0.0.1:8999/api/v1/tags/3
